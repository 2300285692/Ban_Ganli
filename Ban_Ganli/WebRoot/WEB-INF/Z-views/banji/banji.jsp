...
<br/><br/>
        <center>
            <s:form id="domainForm" action="banji_Banlist.action" theme="simple">
                       名称: <s:textfield name="baseQuery.bname" placeholder="名称" />&nbsp;&nbsp;
			...
			<br />
               <table border="1" >
                 <tr style="background-color: ;">
					<th width="20%" ><span><strong>编&nbsp;号</strong></span></th>
					<th width="40%" ><span><strong>名&nbsp;称</strong></span></th>
					<th colspan="2" width="20%"><span><strong>操作</strong></span></th>
				</tr>
				<s:iterator value="pageList.rows" var="st">
					<tr style="background-color: white;">
					<th><s:property value='bid'/> </th>
					<th><s:property value='bname'/></th>
					<td ><button type="button" class=""
								onclick="updateDomain('banji_actionUpdate.action?bid=<s:property value='bid'/>');">编辑</button></td>
					<td><button type="button" class=""
								onclick="deleteDomain('banji_delete.action?bid=<s:property value='bid'/>');">删除</button></td>
					</tr>
				</s:iterator>
               </table>
