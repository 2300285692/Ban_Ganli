...
.a1 {
  ...
  <body>
	...
	<div class="top2">
		<div class="title" >
		    <br/>
			<span style="size:18px">&nbsp;班级信息管理系统</span>
			<br/>
		</div>
		...
		<br/>
		 <br/>
			<a href="javascript:void(0);"
					onClick="openurl('help');">
			<i class="ti-user"></i>
			<span style="color: black">登录用户：DeathGhost</span></a> 
		</div>
	</div>
	...
	<div class="right">
		<iframe id="rightFrame" name="rightFrame" width="100%" height="100%"
			...
			<p style="color:black"> 班级信息管理系统 <a href="http://www.stdu.edu.cn/" target="_blank" title="铁大官网">&nbsp;&nbsp;&nbsp;</a></p>
	        </div>
	</div>
  </body>
  <!-- 退出系统的验证 -->
