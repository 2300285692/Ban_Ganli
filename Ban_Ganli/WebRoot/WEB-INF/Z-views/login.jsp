...
<div class="login_m">
<div class="login_logo"><h1><strong>班级信息管理系统</strong></h1></div>
<div class="login_boder">
<div class="login_padding" id="login_model">

  <h2>用户名</h2>
  <label>
   <input type="text" id="username" name="username"  class="txt_input txt_input2" onfocus="if(this.value=='请输入用户名'){this.value='';}" onblur="if(this.value==''){this.value='请输入用户名';}" value="请输入用户名"
      value="${sid}">
  </label>
  <h2>密码</h2>
   <label>
    <input type="password" name="password" id="password" class="txt_input" onfocus="if(this.value=='*******'){this.value='';}" onblur="if(this.value==''){this.value='*******';}" value="*******"
     value="${spassword}">
   </label>
   
    <font
		 size="3px;" style="color: red"> ${msg} </font>
  
  <div class="rem_sub">
    <div class="rem_sub_l">
     <p class="pull-left" align="right"><a id="iforget" href="register.action">&nbsp;注册</a></p>
    </div>
     <p class="forgot" ><a id="iforget" href="../index.jsp">忘记密码 ?&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></p>
  </div>
  <div class="rem_sub">
    <div class="rem_sub_l">
     <input type="checkbox" name="checkbox" id="save_me">
     <label for="checkbox">记住用户信息</label>
    </div>
    <label>
      <input  type="submit" class="sub_button" name="button" id="button" value="登 录" style="opacity: 0.7;" onClick="IMG1_onclick2()"  >
    </label>
  </div>
</div>
...
<br> <br>
 <p align="center"> 班级信息管理系统 <a href="http://www.stdu.edu.cn/" target="_blank" title="铁大官网"></a> - Made by <a >李国帅</a></p>
</body>
